...
from DBRetrieve import update_user_attribute_unencrypted, get_user_attribute_unencrypted, get_user_attribute_encrypted, update_user_attribute_encrypted, get_user_id
...
def generate_qr(user_secret):
    ...
    provisioning_uri = totp.provisioning_uri(name='ElectroWizard', issuer_name='TNMT')
